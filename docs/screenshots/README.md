...
- From the disposable Git repository `/tmp/milo-demo-project`, `MILO_HOME=/tmp/milo-interface-home milo` followed by the visibly entered task in `codex-chat.png`; that isolated setup selected Codex with `gpt-5.4-mini` at Milo's low-effort default. Its temporary state was deleted after capture.
...
- `codex-chat.png`: `547b4e9f799672b400210756839a98e9ed34770a05901843964bab7eb54d5f87`
